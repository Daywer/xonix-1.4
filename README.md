...
- `<level_number>` — a number from `1` to `99`
...
Перемещайтесь по полю, захватывайте территорию и избегайте врагов.
